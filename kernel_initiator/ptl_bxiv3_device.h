...
#define PTL_BXIV3_MAX_FR_PAGES 32
...
#define PTL_SRV_ME_OPTS                                                        \
  (PTL_ME_OP_PUT | PTL_ME_EVENT_LINK_DISABLE | PTL_ME_MAY_ALIGN |              \
   PTL_ME_IS_ACCESSIBLE | PTL_ME_NO_TRUNCATE | PTL_ME_USE_ONCE)
...
struct ptl_bxiv3_device {
  ...
  /*Event queue only for the connection staff
   * (PTL_OPEN_CONNECTION_REQUEST,...)*/
