...
//#define PTL_SRV_ME_OPTS   (PTL_ME_OP_PUT | PTL_ME_OP_GET | PTL_ME_EVENT_LINK_DISABLE | PTL_ME_MAY_ALIGN | PTL_ME_IS_ACCESSIBLE | PTL_ME_NO_TRUNCATE | PTL_ME_USE_ONCE)
#define PTL_SRV_ME_OPTS   (PTL_LE_OP_PUT | PTL_LE_OP_GET | PTL_LE_EVENT_LINK_DISABLE | PTL_LE_IS_ACCESSIBLE | PTL_LE_USE_ONCE)
